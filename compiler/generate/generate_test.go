...
`,
	...
	bridge := generatedFileContent(t, plan, "cmd/shop/"+bridgeFilename)
	for _, expected := range []string{
		"package main",
		"func spiceMain(arguments []string) int",
		"= spicegen.Components",
		"example.com/discovery/internal/spicegen/shop",
	} {
		if !strings.Contains(string(bridge), expected) {
