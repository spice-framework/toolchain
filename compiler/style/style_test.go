...
func TestBuildAcceptsJavaStructuredSource(t *testing.T) {
	program, resolution, providers := loadStyleFixture(t, map[string]string{
		"app/package.go": `// Package app owns workers.
package app
`,
...
func TestBuildRejectsJavaStructuredViolations(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: "receiver-method-outside-type-file",
		},
		{
			name: "free function",
			files: map[string]string{
...
`,
		...
		},
		{
			...
			want: "constructor-outside-type-file",
		},
		{
			name: "package file declaration",
			files: map[string]string{
				"app/package.go": "package app\n\nconst Name = \"app\"\n",
			},
			want: "package-file-declaration",
		},
		{
			name: "mutable global",
			files: map[string]string{
		...
		},
		{
			...
			want: "implicit-managed-interface",
		},
	}
