...
func TestAttachOfficialMapsEverySupportedCapability(t *testing.T) {
	...
	tests := []struct {
		...
		{"Component", nil, sdk.ContributionStereotype},
		{"Repository", nil, sdk.ContributionStereotype},
		{"Controller", nil, sdk.ContributionController},
		{"Configuration", nil, sdk.ContributionStereotype},
		{"ConfigurationProperties", nil, sdk.ContributionConfiguration},
		{"Enum", nil, sdk.ContributionEnum},
