...
func TestOfficialHandlersReturnTypedContributions(t *testing.T) {
	...
	tests := []handlerTestCase{
		...
		handlerCase("component", coreannotation.ComponentHandler, "core", "Component", sdk.ContributionStereotype),
		...
		handlerCase("configuration", coreannotation.ConfigurationHandler, "core", "Configuration", sdk.ContributionStereotype),
		handlerCaseWithArguments("configuration properties", coreannotation.ConfigurationPropertiesHandler, "core", "ConfigurationProperties", sdk.ContributionConfiguration, stringToolArgument("prefix", "server")),
		handlerCase("enum", coreannotation.EnumHandler, "core", "Enum", sdk.ContributionEnum),
...
func TestHandlerArgumentValidationFailsClosed(t *testing.T) {
	...
	tests := []handlerFailureTestCase{
		...
		handlerFailureCase("unnamed non-positional", coreannotation.ConfigurationPropertiesHandler, "core", "ConfigurationProperties", toolArgument("", sdk.KindString, "server")),
		handlerFailureCase("unsupported name", coreannotation.ConfigurationPropertiesHandler, "core", "ConfigurationProperties", stringToolArgument("unknown", "server")),
		handlerFailureCase("duplicate", coreannotation.ConfigurationPropertiesHandler, "core", "ConfigurationProperties", stringToolArgument("prefix", "one"), stringToolArgument("prefix", "two")),
