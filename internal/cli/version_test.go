...
func TestWriteVersionIdentity(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "development", version: developmentVersion, commit: developmentCommit, want: "spice v0.1.0-preview.7 (development)\n"},
		{name: "release", version: "0.1.0-preview.7", commit: commit, want: "spice 0.1.0-preview.7 (" + commit + ")\n"},
	} {
...
func TestWriteVersionIdentityRejectsInvalidLinkerBoundaries(t *testing.T) {
	...
	for _, test := range []struct{ name, version, commit string }{
		...
		{name: "unset commit", version: "0.1.0-preview.7"},
		{name: "release version with development commit", version: "0.1.0-preview.7", commit: developmentCommit},
		{name: "development version with release commit", version: developmentVersion, commit: commit},
		{name: "version has v prefix", version: "v0.1.0-preview.7", commit: commit},
