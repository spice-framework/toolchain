...
func TestRunRejectsInvalidArguments(t *testing.T) {
	...
	valid := []string{
		...
		"-version", "v0.1.0-preview.5", "-commit", strings.Repeat("a", 40),
	...
	for _, test := range []struct {
		...
		{name: "stale preview.4", arguments: replaceDistributionArgument(valid, "-version", "v0.1.0-preview.4"), wantCode: 1, wantError: "do not match"},
	} {
